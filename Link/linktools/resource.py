...
class Resource(object):
    _res_path = os.path.abspath(os.path.join(__file__, "..", "..", "resource"))
    ...
    def get_cache_path(self, *paths: [str], create_dir: bool = False, create_file: bool = False):
        path = os.path.join(self._res_path, "cache", *paths)
