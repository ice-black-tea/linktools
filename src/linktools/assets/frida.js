...
}(), r = require("./loader"), i = new r.ScriptLoader;

rpc.exports = {
  loadScripts: i.load.bind(i)
};

var l = new e, o = {}, u = require("./lib/c"), s = require("./lib/java"), a = require("./lib/android"), h = require("./lib/objc"), v = require("./lib/ios"), f = new t, p = new n, c = new u.CHelper, b = new s.JavaHelper, d = new a.AndroidHelper, g = new h.ObjCHelper, m = new v.IOSHelper;
...
},{"./lib/android":2,"./lib/c":3,"./lib/ios":4,"./lib/java":5,"./lib/objc":6,"./loader":7}],2:[function(require,module,exports){
"use strict";
...
var e = function() {
  ...
  return e.prototype.load = function(e, r) {
    for (var t = 0, a = e; t < a.length; t++) {
      var o = a[t];
      try {
        var c = "exec_".concat(o.filename.replace(/[^A-Za-z0-9_]+/gi, "_"));
        (0, eval)("(function ".concat(c, "(parameters) {").concat(o.source, "\n})\n") + "//# sourceURL=".concat(o.filename))(r);
      } catch (e) {
        var n = e.hasOwnProperty("stack") ? e.stack : e;
        throw new Error("Unable to load ".concat(o.filename, ": ").concat(n));
      }
    }
  }, e;
}();

exports.ScriptLoader = e;

},{}]},{},[1])
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
